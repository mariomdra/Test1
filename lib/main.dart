...
import 'package:startup_index/login/login_widget.dart';
import 'flutter_flow/flutter_flow_theme.dart';
...
class _MyAppState extends State<MyApp> {
  ...
  Stream<StartupIndexFirebaseUser> userStream;
  StartupIndexFirebaseUser initialUser;
  ...
  void initState() {
    super.initState();
    userStream = startupIndexFirebaseUserStream()
